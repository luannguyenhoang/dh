...
export const Footer = ({ footerData }: { footerData?: any }) => {
  ...
  const groupText2 = footerData?.text13 || "Group Facebook: Tư vấn Đại Học Từ Xa - Cơ hội cùng văn bằng thứ 2";
  const pageLink = footerData?.text13 || "https://www.facebook.com/TNUElearning";

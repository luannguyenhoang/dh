...
export const Footer = ({ footerData }: { footerData?: any }) => {
  ...
  const groupLink1 = footerData?.text10 || "https://www.facebook.com/groups/800071498531146";
  const groupText1 = footerData?.text9 || "Group Facebook: Đại học Thái Nguyên hệ trực tuyến";
  const groupLink2 = footerData?.text12 || "https://www.facebook.com/groups/tuvandaihoctuxa";
  const groupText2 = footerData?.text11 || "Group Facebook: Tư vấn Đại Học Từ Xa - Cơ hội cùng văn bằng thứ 2";
  const pageLink = footerData?.text14 || "https://www.facebook.com/TNUElearning";

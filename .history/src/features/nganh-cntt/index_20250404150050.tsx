...
import { extractMetaContent, generateMetadataFromFullHead } from "@/ultil/seoUtils";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!seo?.fullHead) {
    return {
      ...
      description: "Thông tin về ngành Công nghệ thông tin",
      robots: "index, follow",
    };
  }
...
export const Cntt = async () => {
  ...
  const jsonLdContent = extractMetaContent(processedFullHead, "application/ld+json");

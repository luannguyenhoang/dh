...
export const Notify = ({ notifyData }: NotifyProps) => {
  ...
  const desc = notifyData?.noiDung || "Thông báo tuyển sinh hệ từ xa Đại học Thái Nguyên 2023";
  const imageSrc = notifyData?.cot?.anh?.node?.mediaItemUrl || "/phoi-bang-dh-thai-nguyen.jpg";
